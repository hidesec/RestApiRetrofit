package com.example.latihanrestapi.activity
...
import com.example.latihanrestapi.R
import com.example.latihanrestapi.adapter.MovieAdapter
import com.example.latihanrestapi.model.Movie
import com.example.latihanrestapi.model.MovieResponse
import com.example.latihanrestapi.service.ApiClient
import com.example.latihanrestapi.service.ApiInterface
        ...
        call.enqueue(object : Callback<Movie> {
            ...
            override fun onResponse(call: Call<Movie>?, response: Response<Movie>?) {
                if (response != null) {
                    ...
                    if (posterPath == null) {
                        collapseImage.setImageResource(R.drawable.usericon)
                    } else {
